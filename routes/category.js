...
router.put('/:id', isAuth, isAdmin, validate, idValidator, categoryController.updateCategory);
router.delete('/:id', isAuth, isAdmin, validate, idValidator, categoryController.deleteCategory);
